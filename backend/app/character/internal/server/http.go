...
func NewHTTPServer(c *conf.Server, characterSvc *service.CharacterService, logger log.Logger) *http.Server {
	...
	v1.RegisterCharacterServiceHTTPServer(srv, characterSvc)
	return srv
}
