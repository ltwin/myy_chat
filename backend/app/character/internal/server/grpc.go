...
func NewGRPCServer(c *conf.Server, characterSvc *service.CharacterService, logger log.Logger) *grpc.Server {
	...
	v1.RegisterCharacterServiceServer(srv, characterSvc)
	return srv
}
